...
Other attributes are copied across verbatim, and callable attributes will continue to work.
...
defined in the css file - not their order in which they appear in the class.